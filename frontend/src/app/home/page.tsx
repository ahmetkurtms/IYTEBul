            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex items-center space-x-4 flex-1 justify-center">
                ...
                <div className="relative">
                  <button
                    className="flex items-center px-2 py-2 bg-white border border-gray-200 rounded-lg shadow-sm text-gray-800 font-medium hover:border-[#801d21] focus:border-[#801d21] transition-colors cursor-pointer"

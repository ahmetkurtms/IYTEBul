  ...
  return (
    <div className="sticky top-0 z-30 bg-white bg-opacity-95 backdrop-blur shadow-md rounded-b-xl mb-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-3">
        ...
        {/* Orta: Search, Calendar, Filter, Sort */}
        <div className="flex items-center flex-1 gap-2 min-w-0 justify-center">
          {/* Search Bar ve Sort butonu ayrı kutular */}
          <div className="flex items-center gap-2 w-full max-w-2xl">
            ...
            <div className="flex items-center flex-1 bg-gray-100 rounded-xl border border-white/70 px-4 min-h-[38px] h-[42px] focus-within:border-[#801d21] transition-colors relative">
              ...
              <div className="relative flex items-center">
                <FiCalendar
                  className={`text-2xl ml-3 cursor-pointer hover:text-gray-800 transition-colors ${((dateStart && dateStart.trim()) || (dateEnd && dateEnd.trim())) ? 'text-[#9a0e20]' : 'text-gray-600'}`}
              ...
              <div className="relative flex items-center">
                <FiFilter
                  className={`text-2xl ml-2 cursor-pointer hover:text-gray-800 transition-colors ${(selectedCategories.length > 0 || selectedLocations.length > 0) && !filterPopoverOpen ? 'text-[#761a1e]' : 'text-gray-600'}`}
                  onClick={() => {
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={onNewPost}
            className="bg-[#9a0e20] text-white px-4 py-2 rounded-lg hover:bg-[#7a0b19] transition-colors flex items-center space-x-2 text-sm font-medium cursor-pointer ml-2"
          >
